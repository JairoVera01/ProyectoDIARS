<%-- 
    ...
    Created on : 24/11/2021, 09:58:33 PM
    Author     : jairo
--%>
...
<html>
    <head>
        ...
        <title>Aldana Go - Ver::${producto.nombre}</title>
    </head>
    <body>
            ...
            <nav arial-label ="breadcrumb">
                <ol class="breadcrumb">
                    <li class="breadcrumb-item" aria-current="page">
                        <a href="listarProducto.htm">Listado Productos</a>
                    </li>
                    <li class="breadcrumb-item" aria-current="page">
                        ${producto.nombre}
                    </li>
                    ...
                    <div class="row ">
                       <%--Imagen seccion del 30% --%> 
                          <article class="col-6 col-12-xsmall work-item">
                              <img src="${producto.url_imagen}" height="100%" width="100%" /></a>				
                          </article> 
                       ...
                       <%--Datos seccion del 70% --%> 
                          <article class="col-6 col-12-xsmall work-item">
                              ...
                              <div class="d-flex justify-content-around">                                     
                                  ...
                                  <a href="https://api.whatsapp.com/send?phone=51989913836}" target="_blank" class="btn btn-success">
                                        <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-whatsapp" viewBox="0 0 18 18">
